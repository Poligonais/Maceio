...
map.getView().fit([-3985135.617279, -1089805.200648, -3970566.430229, -1081923.335415], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Poligonal da Área do Porto Organizado de Macéio</h2>';
        return titleElement;
    })(),
